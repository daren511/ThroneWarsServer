<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MOBILEForgotUsername.aspx.cs" Inherits="SiteWebThroneWars.MOBILEForgotUsername" %>
...
<link href="/Menu/jquery.mmenu.css" type="text/css" rel="stylesheet" />
    ...
    <nav id="my-menu">
		...
		<div class="FormForgot_Mobile">
  			Courriel: <br />
            <asp:Textbox ID="TB_Email" TextMode="Email" runat="server" style="width: 34%; font-size:30px;"/><br/><br/>
  			<asp:Button Text="Envoyer" runat="server" onclick="UsernameRecovery_Click" style="width: 20%; font-size:35px;"/>
  		</div>
        </form>
  	</body>
</html>
