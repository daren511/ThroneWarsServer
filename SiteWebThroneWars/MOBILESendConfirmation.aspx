<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MOBILESendConfirmation.aspx.cs" Inherits="SiteWebThroneWars.MOBILESendConfirmation" %>
...
<body>
    ...
    <nav id="my-menu">
        ...
        <div class="Entete_Mobile">
            ...
            <asp:TextBox ID="TB_Username" TextMode="SingleLine" runat="server" style="width: 38%; font-size:30px;" /><br/><br />
            <asp:Button Text="Envoyer" ID="SendLinkBack" runat="server" OnClick="SendLinkBack_Click" style="width:20%; font-size:35px;"/>
            </div>
